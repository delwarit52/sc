...
<div class="row">
    <div class="col-12">
        <div class="page-title-box">
            <h4 class="page-title float-left">Division</h4>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card-box w-100">
                <h4 class="m-t-0 header-title"><b>Division Table</b></h4>
                 <!-- Large modal -->
                ...
                <table id="datatable-buttons" class="table table-striped table-bordered add-edit-table" cellspacing="0" width="100%">
                    ...
                    <tr>
                        <td>{{ $count++ }}</td>
                        <td>{{ $division->name }}</td>
                        <td><img src="{{ asset('storage/'.$division->image) }}" alt="" width="50px" height="50px"></td>
                        <td>{{ 27 }}</td>
                        <td>2011/01/25</td>
                        <td>
                            <!-- Large modal -->
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body card-block">
                                                        ...
                                                        <div class="has-warning form-group">
                                                            ...
                                                            <img class="img-thumbnail" src="{{ asset('../storage/'.$division->image) }}" alt="{{ $division->name }}" id="photoEdit" style="height: 100%; width: 100%;">
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
