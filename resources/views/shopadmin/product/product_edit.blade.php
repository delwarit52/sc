                                ...
                                <div class="au-breadcrumb-content">
                                    <div class="au-breadcrumb-left">
                                        ...
                                        <ul class="list-unstyled list-inline au-breadcrumb__list">
                                            ...
                                            <li class="list-inline-item">Basic Edit Product</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col col-sm-12 col-md-6">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="text" id="product-name" name="name" class="form-control @error('name') is-invalid  @enderror" placeholder="Product Title" value="{{ $product->name }}">
                                        @error('name')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                        ...
                        <div class="row">
                            <div class="col col-sm-12 col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="number" id="product_price" name="product_price" value="{{ $product->product_price }}" class="form-control @error('product_price') is-invalid  @enderror" placeholder="Product Price">
                                        @error('product_price')
                                            <span class="invalid-feedback text-danger" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </span>
                            ...
                            <div class="col col-sm-12 col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <input type="number" id="product-price-discount" name="product_price_discount" value="{{ $product->product_price_discount }}" class="form-control @error('product_price_discount') is-invalid  @enderror" placeholder="Product Price Discount(%)">
                        ...
                        <div class="row">
                            <div class="col col-sm-12 col-md-12">
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <textarea name="product_small_description" value="{{ old('product_small_description') }}" id="" cols="10" class="form-control @error('product_small_description') is-invalid  @enderror">
                                            {{ $product->product_small_description }}
                                        </textarea>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <textarea id="elm1" name="product_full_description" value="{{ old('product_full_description') }}" class="@error('product_full_description') is-invalid  @enderror">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="card-box">
                                    ...
                                    <textarea id="elm1" name="product_shipping_and_return" value="{{ old('product_shipping_and_return') }}" class="@error('product_shipping_and_return') is-invalid  @enderror">
